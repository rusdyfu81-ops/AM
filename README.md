# Direktori Tenant Mall — Prototipe
...
| `tenant.html?kios=L3-06` | Pemilik toko | Portal tenant. **Target QR toko.** |
...
3. **QR toko** (L3-06 belum diaktivasi) → peserta memindai, melihat portalnya, menekan *Simulasikan aktivasi*.
